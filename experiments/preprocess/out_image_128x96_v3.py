...
BLUE = (0, 255, 0)
output_size = (128, 96)
output_dir = f"../../output/preprocess/images/images_{output_size[0]}x{output_size[1]}_v3"
traintest = "train"
        ...
        for view in ["Endzone", "Sideline"]:
            ...
            for frame in range(frame_count):
                ...
                for key, w_df in data_dict.items():
                    ...
                    img = cv2.addWeighted(src1=img, alpha=0.8, src2=img_filter, beta=0.2, gamma=0)
