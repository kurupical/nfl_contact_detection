...
def main():
    ...
    df_tracking = pd.read_feather("../../output/preprocess/master_data/gps.feather")
        ...
        for view in ["Endzone", "Sideline"]:
            ...
            for key, w_df in gp[gp["view"] == view].groupby(["nfl_player_id_1", "nfl_player_id_2"]):
                ...
                for frame in range(len(imgs)):
                    ...
                    out_fname = f"{output_dir}/images_{output_size[0]}x{output_size[1]}/{game_play}/{view}/{key[0]}_{key[1]}_{frame}.npy"
