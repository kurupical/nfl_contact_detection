...
PLAYER = (255, 0, 0)
output_size = (128, 96)
output_dir = f"../../../work/images_{output_size[0]}x{output_size[1]}_v27"
traintest = "train"
...
def main():
    ...
    for key, df_ in tqdm.tqdm(df_helmets_.groupby(["game_play", "view", "nfl_player_id", "team"])):
        ...
        for col in ["x", "y", "left", "top", "width", "height"]:
            df_[col] = df_[col].interpolate(limit=30, limit_area="inside")
    ...
    for i, game_play in enumerate(tqdm.tqdm(game_plays)):
        ...
        for view in ["Endzone", "Sideline"]:
            ...
            for frame in range(frame_count):
                ...
                img_ = cv2.addWeighted(src1=img_, alpha=0.85, src2=img_filter, beta=0.15, gamma=0)
