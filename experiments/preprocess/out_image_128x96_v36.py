...
PLAYER = (255, 0, 0)
output_size = (128, 96)
output_dir = f"../../../work/images_{output_size[0]}x{output_size[1]}_v36"
traintest = "train"
            ...
            for frame in range(frame_count):
                ...
                for key, w_df in data_dict.items():
                    ...
                    if view == "Endzone":
                        ...
                        video_ratio = side_ratio
                    left = int(series["x"] - series["bbox_size"] * bbox_left_ratio * video_ratio)
                    right = int(series["x"] + series["bbox_size"] * bbox_right_ratio * video_ratio)
                    top = int(series["y"] + series["bbox_size"] * bbox_top_ratio * video_ratio)
                    down = int(series["y"] - series["bbox_size"] * bbox_down_ratio * video_ratio)
