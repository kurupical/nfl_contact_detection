...
if __name__ == "__main__":
    ...
    exp_name = f"2.5d3d_n_predict_frames5_step3_n_frames87_gamma0.33_stepratio0.15"
    config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
                    model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=1, step=3,
                    negative_sample_ratio_g=1,
                    negative_sample_ratio_far=1,
    ...
    for warmup in [0.05, 0.1]:
        exp_name = f"2.5d3d_n_predict_frames5_step3_n_frames87_warmup{warmup}"
        config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
                        model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=1, step=3,
                        negative_sample_ratio_g=1,
                        negative_sample_ratio_far=1,
    ...
    exp_name = f"3d_72x96_nframes63_pred3"
    ...
    exp_name = f"2.5d3d_n_predict_frames5_step3_n_frames87_transformer"
    config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
                    model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=1, step=3,
                    negative_sample_ratio_g=1,
                    negative_sample_ratio_far=1,
