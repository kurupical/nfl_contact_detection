...
class NFLTransformerDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return contact_id, torch.Tensor(feature), torch.Tensor(labels), torch.Tensor(mask), dummy
...
if __name__ == "__main__":
    ...
    # exp_name = f"2d1d_interpolateFalse"
    ...
    # exp_name = f"2d1d_interpolate_outside_False"
    # config = Config(exp_name=exp_name, n_frames=303, seq_model="1dcnn_simple",
    #                 model_name=f"cnn_2d1d", step=3,
    #                 batch_size=128,
    #                 kernel_size_conv1d=31,
    ...
    #     exp_name = f"2d1d_wd{weight_decay}"
    #     config = Config(exp_name=exp_name, n_frames=303, seq_model="1dcnn_simple",
    #                     model_name=f"cnn_2d1d", step=3,
    #                     batch_size=128,
    #                     kernel_size_conv1d=31,
    ...
    #     main(config)
    #
    # for n_predict_frames in [5, 9, 13]:
    #     exp_name = f"2d1d_wd{weight_decay}"
    #     config = Config(exp_name=exp_name, n_frames=303, seq_model="1dcnn_simple",
    #                     model_name=f"cnn_2d1d", step=3,
    #                     batch_size=128,
    ...
    #     main(config)
    #
    # for lr_fc in [0.25e-3, 0.5e-3, 2e-3]:
    #     exp_name = f"2d1d_lr_fc{lr_fc}"
    #     config = Config(exp_name=exp_name, n_frames=303, seq_model="1dcnn_simple",
    #                     model_name=f"cnn_2d1d", step=3,
    #                     batch_size=128,
    #                     kernel_size_conv1d=31,
    ...
    config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
                    ...
                    n_predict_frames=3,
                    calc_single_view_loss_weight=1,
                    image_path="images_128x96_v11"
                    )
    main(config)

    for n_predict_frames in [5, 9, 13]:
        exp_name = f"2d1d_n_predict_frames{n_predict_frames}"
        config = Config(exp_name=exp_name, n_frames=303, seq_model="1dcnn_simple",
                        model_name=f"cnn_2d1d", step=3,
                        batch_size=128,
                        kernel_size_conv1d=31,
    ...
    for p_drop_frame in [0.05, 0.1]:
        exp_name = f"2d1d_interpolateFalse_n_predict_frames{n_predict_frames}_dropframe{p_drop_frame}"
        config = Config(exp_name=exp_name, n_frames=303, seq_model="1dcnn_simple",
                        model_name=f"cnn_2d1d", step=3,
                        batch_size=128,
                        kernel_size_conv1d=31,
    ...
    exp_name = f"2.5d3d_2epochs_step_ratio0.6_contact0.5"
    config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    ...
    exp_name = f"2.5d3d_2epochs_step_ratio0.6_contact0.2"
    config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
                    model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
                    step_size_ratio=0.6,
                    hidden_size_3d=512,
    ...
    exp_name = f"2.5d3d_2epochs_step_ratio0.6_g0.1"
    config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
                    model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
                    step_size_ratio=0.6,
                    hidden_size_3d=512,
    ...
    exp_name = f"2.5d3d_seresnet34_nframes33"
