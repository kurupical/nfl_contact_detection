...
class Config:
    ...
    try:
        feature_cols: List[str] = pd.read_csv(
            "../../output/lgbm/exp028/20230223074848/feature_importance.csv"
        )["col"].values[:100]
    except:
...
class Model2p5DTo3D(nn.Module):
    def __init__(self,
        ...
        if config.seq_model_short:
            ...
            config_.kernel_size_3d = (config.kernel_size_3d[0]//2, config.kernel_size_3d[1], config.kernel_size_3d[2])
...
if __name__ == "__main__":
    # exp_name = f"2.5d3d_v33_use_data_step2_epochs3"
    # config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=3, step=3,
    #                 step_size_ratio=1.5,
    #                 use_data_step=2,
    #                 hidden_size_3d=512,
    ...
    # main(config)
    #
    # exp_name = f"3d_v32_use_data_step2_epochs3"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=3,
    #                 step_size_ratio=1.5,
    #                 use_data_step=2,
    #                 negative_sample_ratio_g=0.1,
    #                 negative_sample_ratio_close=0.1,
    ...
    # main(config)
    #
    # for n_predict_frames in [11, 9]:
    #     for v in [21, 33]:
    #         exp_name = f"2.5d3d_v{v}_n_predict_frames{n_predict_frames}_consider_step"
    #         config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                         model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                         step_size_ratio=1,
    #                         use_data_step=n_predict_frames,
    #                         hidden_size_3d=512,
    ...
    #         main(config)
    #
    #         exp_name = f"3d_v{v}_n_predict_frames{n_predict_frames}_consider_step"
    #         config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                         step=3, epochs=2,
    #                         step_size_ratio=1,
    #                         use_data_step=n_predict_frames,
    ...
    #         main(config)
    #
    # for n_predict_frames in [5, 7]:
    #     # v21 or v33 どっちか強いほうを採用
    #     for v in [21]:
    #         exp_name = f"2.5d3d_v{v}_n_predict_frames{n_predict_frames}_consider_step"
    #         config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                         model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    ...
    #     # v21 or v33 どっちか強いほうを採用
    #     for v in [21]:
    #         exp_name = f"2.5d3d_v{v}_n_predict_frames{n_predict_frames}_0.2-1-1_3epochs"
    #         config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                         model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=3, step=3,
    #                         step_size_ratio=1.5,
    #                         use_data_step=n_predict_frames,
    ...
    #         main(config)
    #
    #         exp_name = f"3d_v{v}_n_predict_frames{n_predict_frames}_0.2-1-1_3epochs"
    #         config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                         step=3, epochs=3,
    #                         step_size_ratio=1.5,
    #                         use_data_step=n_predict_frames,
    ...
    #         main(config)
    #
    # for n_predict_frames in [7]:
    #     # v21 or v33 どっちか強いほうを採用
    #     for v in [21]:
    #         exp_name = f"2.5d3d_v{v}_n_predict_frames{n_predict_frames}_4epochs"
    #         config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                         model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=4, step=3,
    #                         step_size_ratio=2,
    #                         use_data_step=n_predict_frames,
    #                         hidden_size_3d=512,
    #                         negative_sample_ratio_g=1,
    ...
    #         main(config)
    #
    #         exp_name = f"3d_v{v}_n_predict_frames{n_predict_frames}_4epochs"
    #         config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                         step=3, epochs=4,
    #                         step_size_ratio=2,
    #                         use_data_step=n_predict_frames,
    ...
    # for v in [21]:
    #     n_predict_frames = 3
    #     exp_name = f"2.5d3d_v{v}_n_predict_frames{n_predict_frames}_softlabel"
    #     config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                     model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=2,
    #                     step_size_ratio=1,
    #                     use_data_step=n_predict_frames,
    #                     hidden_size_3d=512,
    #                     negative_sample_ratio_g=1,
    ...
    #
    #     n_predict_frames = 5
    #     exp_name = f"3d_v{v}_n_predict_frames{n_predict_frames}_softlabel"
    #     config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                     step=3, epochs=2,
    #                     step_size_ratio=1,
    #                     use_data_step=n_predict_frames,
    ...
    #     main(config)
    #
    # model = "legacy_seresnet18"
    # exp_name = f"2d_pretrain_{model}"
    # config = Config(exp_name=exp_name, seq_model="1dcnn_simple",
    #                 model_name=f"cnn_2d_{model}", epochs=2, step=3,
    #                 step_size_ratio=1,
    #                 n_frames=31,
    #                 negative_sample_ratio_g=1,
    #                 negative_sample_ratio_close=1,
    #                 negative_sample_ratio_far=1,
    #                 kernel_size_conv1d=9,
    #                 stride_conv1d=1,
    #                 batch_size=32,
    #                 n_predict_frames=3,
    #                 use_data_step=3,
    ...
    # n_predict_frames = 5
    # exp_name = f"3d_v21_n_predict_frames{n_predict_frames}_padimage128"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    #                 n_predict_frames=n_predict_frames,
    #                 lr_fc=1e-3,
    #                 pad_image_values=128,
    #                 calc_single_view_loss_weight=1,
    #                 )
    # main(config)
    #
    # n_predict_frames = 3
    # exp_name = f"2.5d3d_v21_n_predict_frames{n_predict_frames}_padimage128"
    # config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    #
    # n_predict_frames = 5
    # exp_name = f"3d_v21_n_predict_frames{n_predict_frames}_0.1-0.1-0.1_3epochs"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=3,
    #                 step_size_ratio=1.5,
    #                 use_data_step=n_predict_frames,
    ...
    # n_predict_frames = 5
    # exp_name = f"3d_v21_n_predict_frames{n_predict_frames}_use_step3+1_0.1-0.1-0.1_3epochs"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=3,
    #                 step_size_ratio=1.5,
    #                 use_data_step=n_predict_frames//2+1,
    #                 negative_sample_ratio_g=0.1,
    #                 negative_sample_ratio_close=0.1,
    #                 negative_sample_ratio_far=0.1,
    #                 model_name="cnn_3d_r3d_18",
    ...
    # for v in [35, 36]:
    #     n_predict_frames = 3
    #     exp_name = f"2.5d3d_v{v}_n_predict_frames{n_predict_frames}"
    #     config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                     model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                     step_size_ratio=1,
    #                     use_data_step=n_predict_frames,
    ...
    #
    #     n_predict_frames = 5
    #     exp_name = f"3d_v{v}_n_predict_frames{n_predict_frames}"
    #     config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                     step=3, epochs=2,
    #                     step_size_ratio=1,
    #                     use_data_step=n_predict_frames,
    ...
    # n_predict_frames = 9
    # exp_name = f"3d_v21_n_predict_frames{n_predict_frames}_usestep{n_predict_frames//2+1}"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames//2+1,
    ...
    #
    # n_predict_frames = 3
    # exp_name = f"2.5d3d_v21_n_predict_frames{n_predict_frames}_0.1-0.3-0.3-4epochs"
    # config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=4, step=3,
    #                 step_size_ratio=1.5,
    #                 use_data_step=n_predict_frames,
    ...
    #                 gradient_clipping=10,
    #                 interpolate_image=False,
    #                 image_path=f"images_128x96_v21",
    #                 lr_fc=1e-3,
    #                 lr=1e-4,
    #                 n_predict_frames=n_predict_frames,
    #                 calc_single_view_loss_weight=1,
    ...
    #
    # n_predict_frames = 5
    # exp_name = f"3d_v21_n_predict_frames{n_predict_frames}_96x96_frame63"
    ...
    #
    # n_predict_frames = 3
    # exp_name = f"2.5d3d_v21_n_predict_frames{n_predict_frames}_use_data2"
    # config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                 step_size_ratio=1,
    #                 use_data_step=2,
    ...
    # main(config)
    #
    # for smooth in [0.05, 0.1]:
    #     n_predict_frames = 5
    #     exp_name = f"3d_v21_n_predict_frames{n_predict_frames}_smooth{smooth}_focal"
    #     config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                     step=3, epochs=2,
    #                     step_size_ratio=1,
    #                     use_data_step=n_predict_frames,
    ...
    #     main(config)
    #
    # for kernel_size_3d in [(13, 5, 5), (19, 5, 5)]:
    #     n_predict_frames = 3
    #     exp_name = f"2.5d3d_v21_n_predict_frames{n_predict_frames}_kernel{kernel_size_3d}"
    #     config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                     model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                     step_size_ratio=1,
    #                     use_data_step=n_predict_frames,
    ...
    #
    # n_predict_frames = 9
    # exp_name = f"3d_v21_n_predict_frames{n_predict_frames}_usestep5_96x96_frame87"
    ...
    #
    # n_predict_frames = 5
    # exp_name = f"3d_v21_n_predict_frames{n_predict_frames}_96x96_frame63_step2"
    # config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                 step=2, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    #
    # n_predict_frames = 3
    # exp_name = f"2.5d3d_v21_n_predict_frames{n_predict_frames}_warmup0.2"
    # config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                 warmup_ratio=0.2,
    #                 step_size_ratio=1,
    ...
    #
    # n_predict_frames = 5
    # exp_name = f"3d_v21_n_predict_frames{n_predict_frames}_96x96_frame63_maxpool_interpolateFalse"
    # config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    # for smooth in [0.1]:
    #     n_predict_frames = 3
    #     exp_name = f"2.5d3d_v21_n_predict_frames{n_predict_frames}"
    #     config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                     model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                     step_size_ratio=1,
    #                     use_data_step=n_predict_frames,
    ...
    # n_predict_frames = 5
    # exp_name = f"3d_v21_n_predict_frames{n_predict_frames}_maxpool_interpolateFalse"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    # main(config)
    #
    # exp_name = f"2.5d3d_v21_smooth_wd0.1_gd0.2"
    # config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                 step_size_ratio=1.5,
    #                 hidden_size_3d=512,
    ...
    #
    # n_predict_frames = 5
    # exp_name = f"3d_v21_n_predict_frames{n_predict_frames}_maxpool_interpolateFalse_step4"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=4, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    # main(config)
    #
    # for step_size_ratio in [0.8, 1.5]:
    #     n_predict_frames = 5
    #     exp_name = f"3d_v21_n_predict_frames{n_predict_frames}_maxpool_interpolateFalse_stepsize{step_size_ratio}"
    #     config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                     step=3, epochs=2,
    ...
    #
    # n_predict_frames = 5
    # exp_name = f"3d_v21_n_predict_frames{n_predict_frames}_maxpool_interpolateFalse_smooth0.2"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    # main(config)
    #
    # exp_name = f"2.5d3d_v21_bce_wd0.1_gd0.2"
    # config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                 step_size_ratio=1.5,
    #                 hidden_size_3d=512,
    ...
    # main(config)
    #
    # for soft_label_range in [(0.1, 0.9), (0.05, 0.95)]:
    #     exp_name = f"2.5d3d_v21_smoothbce(0.1, 0.9)_wd0.1_gd0.2"
    #     config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                     model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                     step_size_ratio=1.5,
    #                     hidden_size_3d=512,
    ...
    #                     image_path="images_128x96_v21",
    #                     criterion="bcewithlogitsloss",
    #                     soft_label_range=soft_label_range,
    #                     lr_fc=1e-3,
    #                     lr=1e-4,
    #                     n_predict_frames=3,
    #                     calc_single_view_loss_weight=1,
    ...
    # for n_frames in [15, 33, 63]:
    #     exp_name = f"2.5d3d_v21_smoothbce(0.1, 0.9)_wd0.1_gd0.2_nframes{n_frames}"
    ...
    #
    # n_predict_frames = 5
    # exp_name = f"3d_v21_n_predict_frames{n_predict_frames}_n_frames15"
    # config = Config(exp_name=exp_name, n_frames=15, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    #                 negative_sample_ratio_g=1,
    ...
    # main(config)
    #
    # for soft_label_range in [(0.2, 0.8)]:
    #     n_predict_frames = 5
    #     exp_name = f"3d_v21_n_predict_frames{n_predict_frames}_maxpool_interpolateFalse_{soft_label_range}"
    #     config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                     step=3, epochs=2,
    #                     step_size_ratio=1,
    #                     use_data_step=n_predict_frames,
    ...
    #
    # n_predict_frames = 5
    # exp_name = f"3d_v21_n_predict_frames{n_predict_frames}_gd0.2"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    #
    # n_predict_frames = 5
    # for negative_ratio in [0.3, 0.5]:
    #     exp_name = f"3d_v21_n_predict_frames{n_predict_frames}_maxpool_interpolateFalse_neg{negative_ratio}"
    #     config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                     step=3, epochs=2,
    #                     step_size_ratio=1,
    #                     use_data_step=n_predict_frames,
    #                     negative_sample_ratio_g=negative_ratio,
    #                     negative_sample_ratio_close=negative_ratio,
    #                     negative_sample_ratio_far=negative_ratio,
    #                     model_name="cnn_3d_r3d_18",
    #                     n_predict_frames=n_predict_frames,
    #                     lr_fc=1e-3,
    #                     interpolate_image=False,
    ...
    #
    # n_predict_frames = 5
    # exp_name = f"3d_v21_n_predict_frames{n_predict_frames}_center96x96_63frames"
    # config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    # main(config)
    #
    # for lr_ratio in [0.5, 1, 2]:
    #     n_predict_frames = 5
    #     exp_name = f"3d_v21_n_predict_frames{n_predict_frames}_bs24_128x96"
    #     config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                     step=3, epochs=2,
    #                     step_size_ratio=1,
    #                     use_data_step=n_predict_frames,
    ...
    # for v in [37]:
    #     exp_name = f"2.5d3d_v{v}_smoothbce(0.1, 0.9)_wd0.1_gd0.2"
    #     config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                     model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                     step_size_ratio=1.5,
    #                     hidden_size_3d=512,
    ...
    # exp_name = f"2.5d3d_v37_smoothbce(0.1, 0.9)_wd0.1_gd0.2_mccloss"
    # config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                 step_size_ratio=1.5,
    #                 hidden_size_3d=512,
    ...
    #                 gradient_clipping=0.2,
    #                 interpolate_image=False,
    #                 image_path=f"images_128x96_v37",
    #                 criterion="mccloss",
    #                 # soft_label_range=(0.1, 0.9),
    #                 lr_fc=1e-3,
    #                 lr=1e-4,
    ...
    #
    #
    # exp_name = f"2.5d3d_v37_smoothbce(0.1, 0.9)_wd0.1_gd0.2_hidden128"
    # config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                 step_size_ratio=1.5,
    #                 hidden_size_3d=128,
    ...
    # v = 37
    # exp_name = f"2.5d3d_v{v}_smoothbce(0.1, 0.9)_wd0.1_gd0.2_gk_gameplay"
    # config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                 step_size_ratio=1.5,
    #                 hidden_size_3d=512,
    ...
    #
    # n_predict_frames = 5
    # exp_name = f"3d_v{v}_n_predict_frames{n_predict_frames}_gk_gameplay"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    #
    # n_predict_frames = 5
    # exp_name = f"3d_v37_n_predict_frames{n_predict_frames}_mccloss"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    #
    # n_predict_frames = 5
    # exp_name = f"3d_v37_n_predict_frames{n_predict_frames}_mccloss_range(0.1, 0.9)"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    # v = 37
    # n_predict_frames = 5
    # exp_name = f"3d_v{v}_n_predict_frames{n_predict_frames}_smoothfocalloss"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    # v = 37
    # n_predict_frames = 5
    # exp_name = f"3d_v{v}_n_predict_frames{n_predict_frames}_smoothfocalloss_63frames_96x96"
    # config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    # for n_features in [100, 200, 400]:
    #     for hidden_size_transformer in [128, 512]:
    #         for nhead in [4, 8, 16]:
    #             use_features = use_features = pd.read_csv(
    #                 "../../output/lgbm/exp026/20230216223836/feature_importance.csv"
    #             )["col"].values[:n_features]
    #             exp_name = f"transformer_mask_{n_features}_hid{hidden_size_transformer}_nhead{nhead}"
    #             config = ConfigForTransformer(exp_name=exp_name,
    #                                           hidden_size_transformer=hidden_size_transformer,
    ...
    # v = 37
    # n_predict_frames = 5
    # exp_name = f"3d_v{v}_n_predict_frames{n_predict_frames}_padimage128(only)"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    # v = 37
    # n_predict_frames = 5
    # exp_name = f"3d_v{v}_n_predict_frames{n_predict_frames}_tfwindow5"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    # main(config)
    #
    # exp_name = f"2.5d3d_v{v}_smoothbce(0.1, 0.9)_wd0.1_gd0.2_tfwindow5"
    # config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                 step_size_ratio=1.5,
    #                 hidden_size_3d=512,
    ...
    #
    # n_predict_frames = 9
    # exp_name = f"3d_v37_n_predict_frames{n_predict_frames}_3epochs_stepratio1.5"
    # config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                 step=3, epochs=3,
    #                 step_size_ratio=1.5,
    #                 use_data_step=n_predict_frames,
    ...
    #
    # n_predict_frames = 7
    # exp_name = f"3d_v37_n_predict_frames{n_predict_frames}_stepratio1.5"
    # config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1.5,
    #                 use_data_step=n_predict_frames,
    ...
    #     for hidden_size_transformer in [128, 512]:
    #         for nhead in [32]:
    #             for apply_lstm in [True]:
    #                 use_features = use_features = pd.read_csv(
    #                     "../../output/lgbm/exp026/20230216223836/feature_importance.csv"
    #                 )["col"].values[:n_features]
    #                 exp_name = f"transformer_mask_{n_features}_hid{hidden_size_transformer}_nhead{nhead}_lstm{apply_lstm}_smooth"
    #                 config = ConfigForTransformer(exp_name=exp_name,
    #                                               hidden_size_transformer=hidden_size_transformer,
    #                                               use_features=use_features,
    #                                               nhead=nhead,
    #                                               apply_lstm=apply_lstm
    #                                               )
    #                 main(config)
    #
    # # bcewithlogitloss
    ...
    #                     "../../output/lgbm/exp026/20230216223836/feature_importance.csv"
    #                 )["col"].values[:n_features]
    #                 exp_name = f"transformer_mask_{n_features}_hid{hidden_size_transformer}_nhead{nhead}_lstm{apply_lstm}_bce"
    #                 config = ConfigForTransformer(exp_name=exp_name,
    #                                               hidden_size_transformer=hidden_size_transformer,
    #                                               use_features=use_features,
    #                                               nhead=nhead,
    ...
    # v = 37
    # n_predict_frames = 5
    # exp_name = f"3d_v{v}_n_predict_frames{n_predict_frames}_wd0.1_gd0.2"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 weight_decay=0.1,
    #                 gradient_clipping=0.2,
    ...
    # v = 37
    # n_predict_frames = 5
    # exp_name = f"3d_v{v}_n_predict_frames{n_predict_frames}_softlabel0.2-0.8"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    # v = 37
    # n_predict_frames = 5
    # exp_name = f"3d_v{v}_n_predict_frames{n_predict_frames}_focalloss_gamma5"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    # v = 37
    # n_predict_frames = 5
    # exp_name = f"3d_v{v}_n_predict_frames{n_predict_frames}_no_label_smoothing"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    #     main(config)
    #
    # for n_predict_frames in [13, 19]:
    #     exp_name = f"3d_v37_n_predict_frames{n_predict_frames}_use_data_step9_3epochs_stepratio1.5"
    #     config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                     step=3, epochs=3,
    #                     step_size_ratio=1.5,
    #                     use_data_step=9,
    ...
    #
    # v = 37
    # for n_predict_frames in [7, 15]:
    #     exp_name = f"2.5d3d_v{v}_smoothbce(0.1, 0.9)_pred{n_predict_frames}_3epochs_step1.5_usedatastep5_allnegsample"
    #     config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                     model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=3, step=3,
    #                     step_size_ratio=1.5,
    #                     hidden_size_3d=512,
    ...
    #     main(config)
    #
    #     exp_name = f"2.5d3d_v{v}_smoothbce(0.1, 0.9)_wd0.1_gd0.2_predframes{n_predict_frames}"
    #     config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                     model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                     step_size_ratio=1.5,
    #                     hidden_size_3d=512,
    ...
    # n_predict_frames = 5
    # v = 37
    # exp_name = f"3d_v{v}_n_predict_frames{n_predict_frames}_grayscale"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    # n_predict_frames = 5
    # v = 37
    # exp_name = f"3d_v{v}_n_predict_frames{n_predict_frames}_exist_frames0.25"
    # config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    #
    # for n_frames in [31, 63, 87]:
    #     exp_name = f"2.5d_v{v}_{model_name}_n_frames{n_frames}"
    #     config = Config(exp_name=exp_name,
    #                     n_frames=n_frames,
    #                     model_name=f"cnn_2.5d_{model_name}",
    #                     epochs=2, step=3,
    #                     step_size_ratio=1,
    #                     use_data_step=n_predict_frames,
    #                     negative_sample_ratio_g=1,
    ...
    #     main(config)
    #
    # for n_frames in [31, 15]:
    #     exp_name = f"2d1d_v{v}_{model_name}_n_frames{n_frames}"
    #     config = Config(exp_name=exp_name,
    #                     n_frames=n_frames,
    #                     model_name=f"cnn_2d_{model_name}",
    #                     seq_model="1dcnn_simple",
    #                     epochs=2, step=3,
    #                     step_size_ratio=1,
    #                     use_data_step=n_predict_frames,
    #                     negative_sample_ratio_g=1,
    ...
    # v = 43
    # n_predict_frames = 5
    # exp_name = f"3d_v{v}_n_predict_frames{n_predict_frames}_smoothfocalloss_63frames_96x96_gkgameplay"
    # config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    ...
    # for n_features in [100, 200]:
    #     for hidden_size_transformer in [128, 256]:
    #         for nhead in [16]:
    #             for apply_lstm in [True]:
    #                 use_features = use_features = pd.read_csv(
    #                     "../../output/lgbm/exp028/20230223074848/feature_importance.csv"
    ...
    # v = 44
    # exp_name = f"2.5d3d_v{v}_allsample_predframes9_usestep5"
    # config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                 step_size_ratio=1.5,
    #                 hidden_size_3d=512,
    ...
    #                 )
    # main(config)
    # for model_name in ["tf_inception_v3", "hrnet_w18", "legacy_seresnet34", "efficientnet_es_pruned"]:
    #     exp_name = f"2.5d3d_v{v}_{model_name}"
    #     config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                     model_name=f"cnn_2.5d3d_{model_name}", epochs=2, step=3,
    #                     kernel_size_3d=(3, 2, 2),
    #                     step_size_ratio=1.5,
    #                     hidden_size_3d=512,
    #                     weight_decay=0.1,
    #                     negative_sample_ratio_g=0.1,
    ...
    #     main(config)
    #
    # exp_name = f"2.5d3d_v{v}_kernel_size(3, 2, 2)"
    # config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                 kernel_size_3d=(3, 2, 2),
    #                 step_size_ratio=1.5,
    ...
    v = 44
    # exp_name = f"2.5d3d_v{v}_transformerwindow15"
    # config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                 step_size_ratio=1.5,
    #                 hidden_size_3d=512,
    ...
    #
    # for step in [2, 4]:
    #     exp_name = f"2.5d3d_v{v}_step{step}"
    #     config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    #                     model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=step,
    #                     step_size_ratio=1.5,
    #                     hidden_size_3d=512,
    #                     weight_decay=0.1,
    #                     negative_sample_ratio_g=1,
    ...
    #     main(config)
    #
    # exp_name = f"2.5d3d_v{v}_n_frames123"
    ...
    #
    # n_predict_frames = 5
    # exp_name = f"3d_v{v}_81frames"
    # config = Config(exp_name=exp_name, n_frames=81, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=n_predict_frames,
    #                 negative_sample_ratio_g=1,
    ...
    # main(config)
    #
    # exp_name = f"3d_v{v}_63frames_negsample0.1-0.1-0.1"
    # config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=1,
    #                 use_data_step=1,
    ...
    #
    # n_predict_frames = 3
    # exp_name = f"3d_v{v}_63frames_1epochs_pred3"
    # config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                 step=3, epochs=1,
    #                 step_size_ratio=0.5,
    #                 use_data_step=n_predict_frames,
    ...
    #
    # n_predict_frames = 3
    # exp_name = f"3d_v{v}_63frames_1epochs_pred3_stepsize0.3"
    # config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                 step=3, epochs=1,
    #                 step_size_ratio=0.3,
    #                 use_data_step=n_predict_frames,
    ...
    # main(config)
    #
    # exp_name = f"2.5d3d_v{v}_n_frames123_1epochs"
    # config = Config(exp_name=exp_name, n_frames=123, seq_model="3dcnn_simple",
    ...
    # n_predict_frames = 5
    # for step in [4]:
    #     exp_name = f"3d_v{v}_63frames_step{step}"
    #     config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                     step=step, epochs=2,
    #                     step_size_ratio=1,
    #                     use_data_step=n_predict_frames,
    ...
    #
    # for soft_label_range in [(0.1, 0.9), (0, 1)]:
    #     exp_name = f"3d_v{v}_63frames+bce{soft_label_range}"
    #     config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                     step=3, epochs=2,
    #                     step_size_ratio=1,
    #                     use_data_step=n_predict_frames,
    ...
    # exp_name = f"3d_v{v}_123frames_predict19_usedatastep9"
    # config = Config(exp_name=exp_name, n_frames=123, seq_model="flatten",
    #                 step=3, epochs=3,
    #                 step_size_ratio=2,
    #                 use_data_step=9,
    #                 negative_sample_ratio_g=1,
    ...
    # main(config)
    #
    # exp_name = f"2.5d3d_v{v}_n_frames255_npred33"
    # config = Config(exp_name=exp_name, n_frames=255, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                 step_size_ratio=1.5,
    #                 hidden_size_3d=512,
    #                 weight_decay=0.1,
    ...
    # main(config)
    #
    # exp_name = f"2.5d3d_v{v}_n_frames255_npred33_kernel(19, 5, 5)"
    # config = Config(exp_name=exp_name, n_frames=255, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                 step_size_ratio=1.5,
    #                 hidden_size_3d=512,
    #                 kernel_size_3d=(19, 5, 5),
    #                 weight_decay=0.1,
    #                 gradient_clipping=0.2,
    #                 interpolate_image=False,
    #                 image_path=f"images_128x96_v{v}",
    ...
    # main(config)
    #
    # exp_name = f"2.5d3d_v{v}_n_frames255_npred33_2layers"
    # config = Config(exp_name=exp_name, n_frames=255, seq_model="3dcnn_2layers",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                 step_size_ratio=1.5,
    #                 hidden_size_3d=512,
    #                 weight_decay=0.1,
    #                 gradient_clipping=0.2,
    #                 kernel_size_3d=(13, 3, 3),
    #                 interpolate_image=False,
    #                 image_path=f"images_128x96_v{v}",
    #                 criterion="bcewithlogitsloss",
    #                 lr_fc=1e-3,
    ...
    # main(config)
    #
    # exp_name = f"2.5d3d_v{v}_n_frames123_pred19"
    # config = Config(exp_name=exp_name, n_frames=123, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                 step_size_ratio=1.5,
    #                 hidden_size_3d=512,
    ...
    # main(config)
    #
    # exp_name = f"3d_v{v}_81frames_predict19_usedatastep9"
    # config = Config(exp_name=exp_name, n_frames=81, seq_model="flatten",
    #                 step=3, epochs=3,
    #                 step_size_ratio=2,
    #                 use_data_step=9,
    ...
    # for n_frames in [61]:
    #     model_name = "legacy_seresnet18"
    #     exp_name = f"2d1d_v{v}_{model_name}_n_frames{n_frames}_3layers"
    #     config = Config(exp_name=exp_name,
    #                     n_frames=n_frames,
    #                     model_name=f"cnn_2d_{model_name}",
    #                     seq_model="1dcnn_3layers",
    #                     epochs=2, step=3,
    #                     step_size_ratio=1.5,
    #                     hidden_size_1d=512,
    #                     negative_sample_ratio_g=0.1,
    ...
    # exp_name = f"3d_v{v}_63frames_predict19_usedatastep9_interpolateFalse_avgpool"
    # config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                 step=3, epochs=3,
    #                 step_size_ratio=2,
    #                 use_data_step=9,
    ...
    # main(config)
    #
    # exp_name = f"3d_v{v}_45frames_predict19_usedatastep9"
    # config = Config(exp_name=exp_name, n_frames=45, seq_model="flatten",
    #                 step=3, epochs=3,
    #                 step_size_ratio=2,
    #                 use_data_step=9,
    #                 negative_sample_ratio_g=1,
    ...
    # main(config)
    #
    # exp_name = f"3d_v{v}_63frames_predict19_usedatastep9_4epochs_2.5stepsize"
    # config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                 step=3, epochs=4,
    #                 step_size_ratio=2.5,
    #                 use_data_step=9,
    ...
    # main(config)
    #
    # for soft_label_range in [(0.1, 0.9), (0.2, 0.8)]:
    #     exp_name = f"3d_v{v}_63frames_predict19_usedatastep9_bce{soft_label_range}"
    #     config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                     step=3, epochs=3,
    #                     step_size_ratio=2,
    #                     use_data_step=9,
    ...
    #     main(config)
    #
    # exp_name = f"2.5d3d_v{v}_n_frames123_shortseq"
    # config = Config(exp_name=exp_name, n_frames=123, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                 step_size_ratio=1.5,
    #                 hidden_size_3d=512,
    ...
    # for soft_label_range in [(0.2, 0.8)]:
    #     exp_name = f"2.5d3d_v{v}_n_frames123_softlabelrange{soft_label_range}"
    #     config = Config(exp_name=exp_name, n_frames=123, seq_model="3dcnn_simple",
    #                     model_name=f"cnn_2.5d3d_legacy_seresnet18", epochs=2, step=3,
    #                     step_size_ratio=1.5,
    #                     hidden_size_3d=512,
    ...
    #
    # for n_frames in [61]:
    #     for soft_label_range in [(0, 1), (0.1, 0.9)]:
    #         model_name = "legacy_seresnet18"
    #         exp_name = f"2d1d_v{v}_{model_name}_n_frames{n_frames}_3layers_bce_(0, 1)"
    #         config = Config(exp_name=exp_name,
    #                         n_frames=n_frames,
    #                         model_name=f"cnn_2d_{model_name}",
    #                         seq_model="1dcnn_3layers",
    ...
    #
    # model_name = "legacy_seresnet18"
    # exp_name = f"2d1d_v{v}_{model_name}_n_frames{n_frames}_3layers_3epochs_pred19_usedatastep9"
    # config = Config(exp_name=exp_name,
    #                 n_frames=n_frames,
    #                 model_name=f"cnn_2d_{model_name}",
    #                 seq_model="1dcnn_3layers",
    ...
    # for lr_ratio in [1]:
    #     exp_name = f"3d_v{v}_63frames_predict19_usedatastep9_128x96_lr_ratio{lr_ratio}"
    #     config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                     step=3, epochs=3,
    #                     step_size_ratio=2.5,
    #                     use_data_step=9,
    ...
    # for lr_ratio in [0.75]:
    #     exp_name = f"3d_v{v}_63frames_predict19_usedatastep9_{lr_ratio}"
    #     config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                     step=3, epochs=3,
    #                     step_size_ratio=2,
    #                     use_data_step=9,
    ...
    # exp_name = f"2.5d3d_v{v}_n_frames123_convnext_atto"
    # config = Config(exp_name=exp_name, n_frames=123, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_convnext_atto", epochs=2, step=3,
    #                 step_size_ratio=1.5,
    #                 hidden_size_3d=512,
    #                 weight_decay=0.1,
    #                 gradient_clipping=0.2,
    ...
    # for model_name in ["convnext_tiny", "convnext_femto"]:
    #     exp_name = f"2.5d3d_v{v}_n_frames81_{model_name}_96x96"
    #     config = Config(exp_name=exp_name, n_frames=81, seq_model="3dcnn_simple",
    #                     model_name=f"cnn_2.5d3d_{model_name}", epochs=2, step=3,
    #                     step_size_ratio=1.5,
    #                     hidden_size_3d=512,
    #                     weight_decay=0.1,
    ...
    # for model_name in ["convnext_femto"]:
    #     exp_name = f"2.5d3d_v{v}_n_frames81_{model_name}"
    #     config = Config(exp_name=exp_name, n_frames=81, seq_model="3dcnn_simple",
    #                     model_name=f"cnn_2.5d3d_{model_name}", epochs=2, step=3,
    #                     step_size_ratio=1.5,
    #                     hidden_size_3d=512,
    ...
    #     main(config)
    #
    # exp_name = f"3d_v{v}_63frames_predict29_usedatastep13"
    # config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                 step=3, epochs=4,
    #                 step_size_ratio=3,
    #                 use_data_step=13,
    ...
    # main(config)
    #
    # exp_name = f"2.5d3d_v{v}_n_frames177_resnet34_96x96"
    # config = Config(exp_name=exp_name, n_frames=177, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet34", epochs=2, step=3,
    #                 step_size_ratio=1.5,
    #                 hidden_size_3d=512,
    #                 weight_decay=0.1,
    ...
    # main(config)
    #
    # exp_name = f"2.5d3d_v{v}_n_frames123_resnet34_stride(1, 1, 1)"
    # config = Config(exp_name=exp_name, n_frames=123, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet34", epochs=2, step=3,
    #                 step_size_ratio=1.5,
    #                 hidden_size_3d=512,
    ...
    # main(config)
    #
    # exp_name = f"3d_v{v}_63frames_predict19_usedatastep9_wd0.01_dis1.5_neg0.5_use5"
    # config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                 step=3, epochs=3,
    #                 step_size_ratio=2,
    #                 weight_decay=0.01,
    ...
    #                 use_data_step=5,
    #                 negative_sample_ratio_g=0.5,
    #                 negative_sample_ratio_close=0.5,
    #                 negative_sample_ratio_far=0.5,
    #                 model_name="cnn_3d_r3d_18",
    #                 n_predict_frames=19,
    #                 lr_fc=1e-3,
    #                 lr=1e-4,
    ...
    # main(config)
    #
    # exp_name = f"2.5d3d_v{v}_n_frames123_shortseq_bugfix"
    # config = Config(exp_name=exp_name, n_frames=123, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet34", epochs=2, step=3,
    #                 step_size_ratio=1.5,
    #                 hidden_size_3d=512,
    ...
    # main(config)
    #
    # exp_name = f"2.5d3d_v{v}_n_frames177_shortseq_bugfix"
    # config = Config(exp_name=exp_name, n_frames=177, seq_model="3dcnn_simple",
    #                 model_name=f"cnn_2.5d3d_legacy_seresnet34", epochs=2, step=3,
    #                 step_size_ratio=1.5,
    #                 hidden_size_3d=512,
    ...
    # main(config)
    #
    # exp_name = f"3d_v{v}_63frames_predict13_usedatastep11"
    # config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                 step=3, epochs=3,
    #                 step_size_ratio=1.5,
    #                 use_data_step=11,
    ...
    # main(config)
    #
    # exp_name = f"3d_v{v}_63frames_predict7_7"
    # config = Config(exp_name=exp_name, n_frames=63, seq_model="flatten",
    #                 step=3, epochs=2,
    #                 step_size_ratio=0.8,
    #                 use_data_step=7,
