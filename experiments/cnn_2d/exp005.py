...
if __name__ == "__main__":
    ...
    exp_name = f"2d_3dcnn_simple"
    config = Config(exp_name=exp_name, n_predict_frames=1, n_frames=31, seq_model="3dcnn_simple")
    main(config)

    image_path = "images_96x96_v2"
    exp_name = f"2d_3dcnn_3layer"
    config = Config(exp_name=exp_name, n_predict_frames=1, n_frames=31, seq_model="3dcnn_3layers")
    main(config)

    image_path = "images_96x96_v2"
    exp_name = f"2d_3dcnn_3layer_GELU"
    config = Config(exp_name=exp_name, n_predict_frames=1, n_frames=31, seq_model="3dcnn_3layers", activation=nn.GELU)
    main(config)
