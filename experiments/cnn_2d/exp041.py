...
if __name__ == "__main__":
    # exp_name = f"2.5d3d_3epochs_step_ratio1_g0.1_contact0.3-0.1"
    ...
    # main(config)
    #
    # for close_ratio in [0.3, 0.5, 1]:
    #     exp_name = f"2.5d3d_2epochs_step_ratio0.6_g0.05_contact{close_ratio}-0.1"
    #     config = Config(exp_name=exp_name, n_frames=87, seq_model="3dcnn_simple",
    ...
    # main(config)
    #
    # exp_name = f"2d1d_contact0.2_step1"
    # config = Config(exp_name=exp_name, n_frames=303, seq_model="1dcnn_simple",
    #                 model_name=f"cnn_2d1d", step=1, epochs=2,
    #                 step_size_ratio=0.6,
    #                 negative_sample_ratio_far=0.2,
    #                 negative_sample_ratio_close=0.2,
    #                 batch_size=128,
    ...
    # main(config)
    #
    # exp_name = f"2d1d_contact0.2_frame83"
    # config = Config(exp_name=exp_name, n_frames=83, seq_model="1dcnn_simple",
    #                 model_name=f"cnn_2d1d", step=3, epochs=2,
    #                 step_size_ratio=0.6,
    #                 negative_sample_ratio_far=0.2,
    #                 negative_sample_ratio_close=0.2,
    ...
    # main(config)
    #
    # exp_name = f"2d1d_contact0.2_frame83_kernel13"
    # config = Config(exp_name=exp_name, n_frames=83, seq_model="1dcnn_simple",
    #                 model_name=f"cnn_2d1d", step=3, epochs=2,
    #                 step_size_ratio=0.6,
    #                 negative_sample_ratio_far=0.2,
    ...
    exp_name = f"3d_gcontact=0.1-0.3-0.1"
    ...
    exp_name = f"3d_v11_gcontact=0.1-0.3-0.1"
    config = Config(exp_name=exp_name, n_frames=31, seq_model="flatten",
                    step=3,
                    epochs=2,
                    step_size_ratio=0.6,
