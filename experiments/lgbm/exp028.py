...
class Model:
    ...
    def feature_engineering(self,
        ...
        for groupby_col in ["is_g", "n_player_distance_all_in_3", "n_player_distance_all_in_2", "step", "is_same_team",
...
def main():
    ...
    # model.train(df, use_half_data=True, apply_focal_loss=True, fold=0, key="game_play")
    # del model.logger
    #
